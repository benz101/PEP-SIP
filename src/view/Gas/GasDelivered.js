...
import { View, Alert, StyleSheet, processColor, ActivityIndicator, Platform } from 'react-native';
...
export default function GasDelivered({ route }) {
    ...
    const loadAssetData = async () => {
        ...
        const { params } = route;
        const body = {
            script_name: "api/v2/api_gas_delivery_asset",
            data: {
                asset: params.asset
            }
        }
        ...
        try {
            ...
            if (json.status !== "0000") {
                ...
                let labelName = [];
                for (i; i <= 12; i++) {
                    let filtered = json.gas_delivery_per_month.filter((item) => item.mon == i)
    ...
    const loadFieldData = async () => {
        ...
        const { params } = route;
        const body = {
            script_name: "api/v2/api_gas_delivery_field",
            data: {
    ...
    const loadPEPData = async () => {
        setLoading(true);
        const body = {
            script_name: "api/v2/api_gas_delivery",
            data: {}
        }
        try {
            const result = await axios.post(`${url.https2}`, body, {
    ...
    const loadBPData = async () => {
        ...
        const { params } = route;
        const body = {
            script_name: "api/v2/api_gas_delivery_bp",
            data: {
