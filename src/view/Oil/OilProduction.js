...
export default function OilProduction({ route }) {
    ...
    const loadAssetData = async () => {
        ...
        const { params } = route;
        const body = {
            script_name: "api/v2/api_oil_production_asset",
            data: {
                asset: params.asset
            }
        }
        try {
            ...
            if (json.status !== "0000") {
                ...
                let totalData = [];
                for (i; i <= 12; i++) {
                    let filtered = json.oil_per_month.filter((item) => item.mon == i)
    ...
    const loadFieldData = async () => {
        ...
        const { params } = route;
        const body = {
            script_name: "api/v2/api_oil_production_field",
            data: {
    ...
    const loadBPData = async () => {
        ...
        const { params } = route;
        const body = {
            script_name: "api/v2/api_oil_production_bp",
            data: {
